...
/*!
 * \brief Implementation of Discretizer for the internal energy form of the
 * energy equation.
 */
class InternalEnergyDiscretizer : public Discretizer
{
public:
    /*!
     ...
     */
    explicit InternalEnergyDiscretizer(const arma::uword nGridPoints);

    /*!
     * \brief Discretize implementation. Calculates the coefficients of the
     * discretized governing equations, with the internal energy form of the
     * energy equation.
     *
     ...
     * equations, with the internal energy form of the energy equation, and
     * stores the result in Discretizer::m_term_i, Discretizer::m_term_ipp and
     ...
     * \param guessHeatCapacityConstantVolume New heat capacity \f$c_v\f$ [J/(kg K)]
     ...
     * \param guess_dZdT_rho New partial derivative \f$\frac{\partial Z}{\partial T}|_\rho\f$ [-]
     */
    void discretizeFromPrimitives(
            ...
            const arma::vec& guessHeatCapacityConstantVolume,
